    ...
    dbc.Row(dbc.Col(dbc.Card(
                dbc.CardBody(
                    [   html.Div(className="card-title1"),
                        ...
                        dbc.Col(html.Div("Le score reflète la probabilité d'appartenance à une classe (label 0: client à privilégier en zone verte; label 1: client à éviter en zone blanche, ex:259945), un seuil de 0.09 les séparant", className='text-sm-center text-dark',
